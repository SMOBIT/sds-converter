...
# Ausgabe des verwendeten Templates
print(f">>> Verwende TEMPLATE_PATH: {TEMPLATE_PATH}")

# Regex für Abschnitts-Header (flexibel Deutsch/Englisch,
# erlaubt Aufzählungszeichen und Gedankenstriche)
...
def iter_block_items(parent):
    ...
    Durchsucht auch verschachtelte Elemente wie Textboxen.
    """
